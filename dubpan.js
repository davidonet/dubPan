  ...
  conProc.on('exit', function(code) {
      ...
      client.select(3, function(err) {
          client.incr("dpcount", function(err, dpcount) {
              ...
              uploadToYoutube("/tmp/test.webm", "#" + dpcount + " Parle avec elles", "Doublage réalisé dans le cadre du Mois des femmes 2016 organisé par la Direction Vie des campus de l'Université de Montpellier.\ninstallation interactive tactile de doublage vidéo développée par David Olivari.\nDu 7 mars au 7 avril 2016 à la fontaine numérique - (S) pace - Campus Triolet.", function(err, data) {
